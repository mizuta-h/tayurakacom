...
function add_front_page_dp_default_options( $dp_default_options ) {
  ...
  // 記事スライダー
	$dp_default_options['index_post_slider_post_type'] = 'recent_post';
	$dp_default_options['index_post_slider_post_order'] = 'date';
	$dp_default_options['index_post_slider_post_num'] = '5';
	$dp_default_options['index_post_slider_title_font_size'] = '32';
	$dp_default_options['index_post_slider_title_font_size_mobile'] = '18';
	$dp_default_options['index_post_slider_show_category'] = '1';
	$dp_default_options['index_post_slider_show_author'] = '1';
	$dp_default_options['index_post_slider_show_date'] = '1';
	$dp_default_options['index_post_slider_show_update'] = '';

  // ヘッダーコンテンツタイプ３
	$dp_default_options['index_header_content_type3_post_type'] = 'recent_post';
	$dp_default_options['index_header_content_type3_post_order'] = 'date';
	$dp_default_options['index_header_content_type3_title_font_size'] = '32';
	$dp_default_options['index_header_content_type3_title_font_size_mobile'] = '18';
	$dp_default_options['index_header_content_type3_show_category'] = '1';
	$dp_default_options['index_header_content_type3_show_author'] = '1';
	$dp_default_options['index_header_content_type3_show_date'] = '1';
	$dp_default_options['index_header_content_type3_show_update'] = '';
	$dp_default_options['index_header_content_type3_use_overlay'] = 1;
	$dp_default_options['index_header_content_type3_overlay_color'] = '#000000';
	$dp_default_options['index_header_content_type3_overlay_opacity'] = '0.3';
  ...
  // コンテンツビルダー
	...
	$dp_default_options['contents_builder'] = array(
		...
		array(
			"cb_content_select" => "category_post",
			"show_content" => 1,
			"headline" => __( 'Headline', 'tcd-w' ),
    ...
    array(
      "cb_content_select" => "featured_content",
      "show_content" => 1,
      "headline" => __( 'Headline', 'tcd-w' ),
      "desc" => __( 'Description will be displayed here.<br>Description will be displayed here.', 'tcd-w' ),
      "show_post_list1" => 1,
      "show_post_list2" => 1,
      "show_post_list3" => 1,
      "post_headline1" => __( 'All post', 'tcd-w' ),
      "post_headline2" => __( 'Featured post', 'tcd-w' ),
      "post_headline3" => __( 'Recommend post', 'tcd-w' ),
      "post_type1" => 'recent_post',
      "post_type2" => 'featured_post',
      "post_type3" => 'recommend_post',
      "post_order1" => 'date',
      "post_order2" => 'rand',
      "post_order3" => 'rand',
      "post_num" => 4,
      "post_num_mobile" => 4,
      "post_animation" => 'type4',
      "title_font_size" => "18",
...
function add_front_page_tab_panel( $options ) {
  ...
  global $dp_default_options, $item_type_options, $time_options, $font_type_options, $content_width_options;
   ...
   <div class="theme_option_field cf theme_option_field_ac">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="theme_option_message2">
      ...
      <p><?php _e('<strong>[Content slider2]</strong><br>You can display blog post, image, MP4 video, Youtube in contents slider.<br>Slider will be displayed on left side and post list will be displayed on right side of header content.<br>In mobile size slider will be displayed on top and post list will be displayed on bottom of header content.', 'tcd-w');  ?></p>
     </div>
     <ul class="design_radio_button2 slider_type_radio_button">
      <li class="index_slider_type1 <?php if($options['index_slider_type'] == 'type1'){ echo 'active'; }; ?>">
      ...
      <li class="index_slider_type2 <?php if($options['index_slider_type'] == 'type2'){ echo 'active'; }; ?>">
      ...
      <li class="index_slider_type3 <?php if($options['index_slider_type'] == 'type3'){ echo 'active'; }; ?>">
     ...
     <?php //記事スライダーの設定 ----- ?>
     <div class="index_slider_type1_area" style="<?php if($options['index_slider_type'] == 'type1') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
       ...
       <div class="sub_box_content">
        ...
        <ul class="option_list">
         <li class="cf"><span class="label"><?php _e('Post type', 'tcd-w');  ?></span>
          <select name="dp_options[index_post_slider_post_type]">
           <option style="padding-right: 10px;" value="recent_post" <?php selected( $options['index_post_slider_post_type'], 'recent_post' ); ?>><?php _e('All post', 'tcd-w');  ?></option>
           <option style="padding-right: 10px;" value="recommend_post" <?php selected( $options['index_post_slider_post_type'], 'recommend_post' ); ?>><?php _e('Recommend post', 'tcd-w');  ?></option>
           <option style="padding-right: 10px;" value="featured_post" <?php selected( $options['index_post_slider_post_type'], 'featured_post' ); ?>><?php _e('Featured post', 'tcd-w');  ?></option>
           <option style="padding-right: 10px;" value="pickup_post" <?php selected( $options['index_post_slider_post_type'], 'pickup_post' ); ?>><?php _e('Pickup post', 'tcd-w');  ?></option>
          </select>
         </li>
         <li class="cf"><span class="label"><?php _e('Post order', 'tcd-w');  ?></span>
          <select name="dp_options[index_post_slider_post_order]">
           <option style="padding-right: 10px;" value="date" <?php selected( $options['index_post_slider_post_order'], 'date' ); ?>><?php _e('Post date', 'tcd-w');  ?></option>
           <option style="padding-right: 10px;" value="rand" <?php selected( $options['index_post_slider_post_order'], 'rand' ); ?>><?php _e('Random', 'tcd-w');  ?></option>
          </select>
         </li>
         <li class="cf"><span class="label"><?php _e('Number of post to display', 'tcd-w');  ?></span>
          <select name="dp_options[index_post_slider_post_num]">
           <?php for($i=4; $i<= 10; $i++): ?>
           <option style="padding-right: 10px;" value="<?php echo esc_attr($i); ?>" <?php selected( $options['index_post_slider_post_num'], $i ); ?>><?php echo esc_html($i); ?></option>
           <?php endfor; ?>
          </select>
         </li>
         <li class="cf"><span class="label"><?php _e('Font size of title', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_post_slider_title_font_size]" value="<?php esc_attr_e( $options['index_post_slider_title_font_size'] ); ?>" /><span>px</span></li>
         <li class="cf"><span class="label"><?php _e('Font size of title (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_post_slider_title_font_size_mobile]" value="<?php esc_attr_e( $options['index_post_slider_title_font_size_mobile'] ); ?>" /><span>px</span></li>
         <li class="cf"><span class="label"><?php _e('Display category', 'tcd-w'); ?></span><input name="dp_options[index_post_slider_show_category]" type="checkbox" value="1" <?php checked( '1', $options['index_post_slider_show_category'] ); ?> /></li>
         <li class="cf"><span class="label"><?php _e('Display date', 'tcd-w'); ?></span><input class="display_option" data-option-name="index_post_slider_show_date" name="dp_options[index_post_slider_show_date]" type="checkbox" value="1" <?php checked( '1', $options['index_post_slider_show_date'] ); ?> /></li>
         <li class="cf index_post_slider_show_date"><span class="label"><?php _e('Display modified date', 'tcd-w'); ?></span><input name="dp_options[index_post_slider_show_update]" type="checkbox" value="1" <?php checked( '1', $options['index_post_slider_show_update'] ); ?> /></li>
         <li class="cf"><span class="label"><?php _e('Display author', 'tcd-w'); ?></span><input name="dp_options[index_post_slider_show_author]" type="checkbox" value="1" <?php checked( '1', $options['index_post_slider_show_author'] ); ?> /></li>
        </ul>
     ...
     <?php //記事スライダー以外の設定 ----- ?>
     <div class="index_slider_type2_area" style="<?php if($options['index_slider_type'] != 'type1') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      ...
      <div class="repeater sortable" data-delete-confirm="<?php _e( 'Delete?', 'tcd-w' ); ?>">
         ...
         <div class="sub_box cf" style="margin-top:20px;">
          ...
          <div class="sub_box_content">
           ...
           <div class="index_slider_background_area" style="<?php if($value['slider_type'] != 'type4') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
            ...
            <div class="theme_option_message2">
             ...
             <div class="index_slider_type3_option" style="<?php if($options['index_slider_type'] == 'type3') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
              ...
              <p><?php _e('Image will be displayed on the left half of the screen on the PC device width. Large image with a large width will automatically cropped from the center and displayed.', 'tcd-w');  ?></p>
             </div>
            </div>
           ...
           <div class="index_slider_post_area" style="<?php if($value['slider_type'] == 'type4') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
            ...
            <ul class="option_list">
             <li class="cf"><span class="label"><?php _e('Post type', 'tcd-w');  ?></span>
              <select name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_type]">
             ...
             <li class="cf"><span class="label"><?php _e('Post order', 'tcd-w');  ?></span>
              <select name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_order]">
             ...
             <li class="cf"><span class="label"><?php _e('Font size of title', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_title_font_size]" value="<?php esc_attr_e( $value['post_title_font_size'] ); ?>" /><span>px</span></li>
             <li class="cf"><span class="label"><?php _e('Font size of title (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_title_font_size_mobile]" value="<?php esc_attr_e( $value['post_title_font_size_mobile'] ); ?>" /><span>px</span></li>
             <li class="cf"><span class="label"><?php _e('Display category', 'tcd-w'); ?></span><input name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_show_category]" type="checkbox" value="1" <?php checked( '1', $value['post_show_category'] ); ?> /></li>
             <li class="cf"><span class="label"><?php _e('Display date', 'tcd-w'); ?></span><input class="display_option" data-option-name="index_slider_<?php echo esc_attr( $key ); ?>_post_show_date" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_show_date]" type="checkbox" value="1" <?php checked( '1', $value['post_show_date'] ); ?> /></li>
             <li class="cf index_slider_<?php echo esc_attr( $key ); ?>_post_show_date"><span class="label"><?php _e('Display modified date', 'tcd-w'); ?></span><input name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_show_update]" type="checkbox" value="1" <?php checked( '1', $value['post_show_update'] ); ?> /></li>
             <li class="cf"><span class="label"><?php _e('Display author', 'tcd-w'); ?></span><input name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_show_author]" type="checkbox" value="1" <?php checked( '1', $value['post_show_author'] ); ?> /></li>
            </ul>
          ...
          <div class="sub_box_content">
           ...
           <div class="button_option_area" style="<?php if($value['show_button'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
            <ul class="option_list button_option_area" style="border-top:1px dotted #ccc; padding-top:12px;">
             ...
             <li class="cf"><span class="label"><?php _e('Font color', 'tcd-w'); ?></span><input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_font_color]" value="<?php echo esc_attr( $value['button_font_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
             <li class="cf button_type1_option"><span class="label"><?php _e('Background color', 'tcd-w'); ?></span><input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_bg_color]" value="<?php echo esc_attr( $value['button_bg_color'] ); ?>" data-default-color="#ffffff" class="c-color-picker"></li>
             ...
             <li class="cf"><span class="label"><?php _e('Background color on mouseover', 'tcd-w'); ?></span><input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_bg_color_hover]" value="<?php echo esc_attr( $value['button_bg_color_hover'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
             <li class="cf non_button_type1_option"><span class="label"><?php _e('Border color on mouseover', 'tcd-w'); ?></span><input type="text" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][button_border_color_hover]" value="<?php echo esc_attr( $value['button_border_color_hover'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
             <li class="cf non_button_type1_option">
       ...
       <?php
            ...
            $value = array(
             ...
             'post_title_font_size_mobile' => '18',
            );
            ob_start();
       ?>
       <div class="sub_box repeater-item repeater-item-<?php echo esc_attr( $key ); ?>">
          ...
          <div class="sub_box_content">
           ...
           <div class="index_slider_post_area" style="<?php if($value['slider_type'] == 'type4') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
            ...
            <ul class="option_list">
             ...
             <li class="cf"><span class="label"><?php _e('Display category', 'tcd-w'); ?></span><input name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_show_category]" type="checkbox" value="1" <?php checked( '1', $value['post_show_category'] ); ?> /></li>
             <li class="cf"><span class="label"><?php _e('Display date', 'tcd-w'); ?></span><input class="display_option" data-option-name="index_slider_<?php echo esc_attr( $key ); ?>_post_show_date" name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_show_date]" type="checkbox" value="1" <?php checked( '1', $value['post_show_date'] ); ?> /></li>
             <li class="cf index_slider_<?php echo esc_attr( $key ); ?>_post_show_date"><span class="label"><?php _e('Display date', 'tcd-w'); ?></span><input name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_show_update]" type="checkbox" value="1" <?php checked( '1', $value['post_show_update'] ); ?> /></li>
             <li class="cf"><span class="label"><?php _e('Display author', 'tcd-w'); ?></span><input name="dp_options[index_slider][<?php echo esc_attr( $key ); ?>][post_show_author]" type="checkbox" value="1" <?php checked( '1', $value['post_show_author'] ); ?> /></li>
            </ul>
           </div><!-- END .index_slider_post_area -->
     ...
     <div class="index_slider_type3_area" style="<?php if($options['index_slider_type'] == 'type3') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      <div class="sub_box cf">
       <h3 class="theme_option_subbox_headline"><?php _e('Post list setting', 'tcd-w');  ?></h3>
       <div class="sub_box_content">
        <div class="theme_option_message2" style="margin-top:20px;">
         <p><?php _e('This post list will be display on right side of header content.', 'tcd-w');  ?></p>
        </div>
        <h4 class="theme_option_headline2"><?php _e('Post list setting', 'tcd-w');  ?></h4>
        <ul class="option_list">
         <li class="cf"><span class="label"><?php _e('Post type', 'tcd-w');  ?></span>
          <select name="dp_options[index_header_content_type3_post_type]">
           <option style="padding-right: 10px;" value="recent_post" <?php selected( $options['index_header_content_type3_post_type'], 'recent_post' ); ?>><?php _e('All post', 'tcd-w');  ?></option>
           <option style="padding-right: 10px;" value="recommend_post" <?php selected( $options['index_header_content_type3_post_type'], 'recommend_post' ); ?>><?php _e('Recommend post', 'tcd-w');  ?></option>
           <option style="padding-right: 10px;" value="featured_post" <?php selected( $options['index_header_content_type3_post_type'], 'featured_post' ); ?>><?php _e('Featured post', 'tcd-w');  ?></option>
           <option style="padding-right: 10px;" value="pickup_post" <?php selected( $options['index_header_content_type3_post_type'], 'pickup_post' ); ?>><?php _e('Pickup post', 'tcd-w');  ?></option>
          </select>
         </li>
         <li class="cf"><span class="label"><?php _e('Post order', 'tcd-w');  ?></span>
          <select name="dp_options[index_header_content_type3_post_order]">
           <option style="padding-right: 10px;" value="date" <?php selected( $options['index_header_content_type3_post_order'], 'date' ); ?>><?php _e('Post date', 'tcd-w');  ?></option>
           <option style="padding-right: 10px;" value="rand" <?php selected( $options['index_header_content_type3_post_order'], 'rand' ); ?>><?php _e('Random', 'tcd-w');  ?></option>
          </select>
         </li>
         <li class="cf"><span class="label"><?php _e('Font size of title', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_header_content_type3_title_font_size]" value="<?php esc_attr_e( $options['index_header_content_type3_title_font_size'] ); ?>" /><span>px</span></li>
         <li class="cf"><span class="label"><?php _e('Font size of title (mobile)', 'tcd-w'); ?></span><input class="font_size hankaku" type="text" name="dp_options[index_header_content_type3_title_font_size_mobile]" value="<?php esc_attr_e( $options['index_header_content_type3_title_font_size_mobile'] ); ?>" /><span>px</span></li>
         <li class="cf"><span class="label"><?php _e('Display category', 'tcd-w'); ?></span><input name="dp_options[index_header_content_type3_show_category]" type="checkbox" value="1" <?php checked( '1', $options['index_header_content_type3_show_category'] ); ?> /></li>
         <li class="cf"><span class="label"><?php _e('Display date', 'tcd-w'); ?></span><input class="display_option" data-option-name="index_header_content_type3_show_update" name="dp_options[index_header_content_type3_show_date]" type="checkbox" value="1" <?php checked( '1', $options['index_header_content_type3_show_date'] ); ?> /></li>
         <li class="cf index_header_content_type3_show_update"><span class="label"><?php _e('Display modified date', 'tcd-w'); ?></span><input name="dp_options[index_header_content_type3_show_update]" type="checkbox" value="1" <?php checked( '1', $options['index_header_content_type3_show_update'] ); ?> /></li>
         <li class="cf"><span class="label"><?php _e('Display author', 'tcd-w'); ?></span><input name="dp_options[index_header_content_type3_show_author]" type="checkbox" value="1" <?php checked( '1', $options['index_header_content_type3_show_author'] ); ?> /></li>
        </ul>
        <h4 class="theme_option_headline2"><?php _e( 'Overlay setting', 'tcd-w' ); ?></h4>
        <p class="displayment_checkbox"><label><input name="dp_options[index_header_content_type3_use_overlay]" type="checkbox" value="1" <?php checked( $options['index_header_content_type3_use_overlay'], 1 ); ?>><?php _e( 'Use overlay', 'tcd-w' ); ?></label></p>
        <div style="<?php if($options['index_header_content_type3_use_overlay'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
         <ul class="option_list" style="border-top:1px dotted #ccc; padding-top:12px;">
          <li class="cf"><span class="label"><?php _e('Color of overlay', 'tcd-w'); ?></span><input type="text" name="dp_options[index_header_content_type3_overlay_color]" value="<?php echo esc_attr( $options['index_header_content_type3_overlay_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
          <li class="cf">
           <span class="label"><?php _e('Transparency of overlay', 'tcd-w'); ?></span><input class="hankaku" style="width:70px;" type="number" max="1" min="0" step="0.1" name="dp_options[index_header_content_type3_overlay_opacity]" value="<?php echo esc_attr( $options['index_header_content_type3_overlay_opacity'] ); ?>" />
           <div class="theme_option_message2" style="clear:both; margin:7px 0 0 0;">
            <p><?php _e('Please specify the number of 0.1 from 0.9. Overlay color will be more transparent as the number is small.', 'tcd-w');  ?></p>
           </div>
          </li>
   ...
   <div class="theme_option_field theme_option_field_ac open active <?php if($options['index_content_type'] == 'type1') { echo 'show_arrow'; }; ?>">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <div class="index_content_type2_option" style="<?php if($options['index_content_type'] == 'type2') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      ...
      <h4 class="theme_option_headline2"><?php _e('Content width setting', 'tcd-w');  ?></h4>
      <ul class="option_list">
       <li class="cf">
        <span class="label"><?php _e('Content width type', 'tcd-w'); ?></span>
        <ul class="design_radio_button">
         <li>
          <input type="radio" id="page_content_width_type1" name="dp_options[page_content_width_type]" value="type1" <?php checked( $options['page_content_width_type'], 'type1' ); ?> />
          <label for="page_content_width_type1"><?php _e('Normal width', 'tcd-w'); ?></label>
         </li>
         <li>
          <input type="radio" id="page_content_width_type2" name="dp_options[page_content_width_type]" value="type2" <?php checked( $options['page_content_width_type'], 'type2' ); ?> />
          <label for="page_content_width_type2"><?php _e('Full screen width', 'tcd-w'); ?></label>
         </li>
        </ul>
       </li>
       <li class="cf page_content_width_type1_option" style="<?php if($options['page_content_width_type'] == 'type1'){ echo 'display:block;'; } else {  echo 'display:none;'; }; ?>">
        <span class="label"><?php _e('Content width', 'tcd-w'); ?></span><input class="hankaku page_content_width_input" style="width:100px;" type="number" name="dp_options[page_content_width]" value="<?php echo esc_attr($options['page_content_width']); ?>" /><span>px</span>
       </li>
      </ul>
      <ul class="button_list cf">
       <li><input type="submit" class="button-ml ajax_button" value="<?php echo __( 'Save Changes', 'tcd-w' ); ?>" /></li>
     ...
     <ul class="design_button_list cf">
      <li><a data-rel="lightcase:indexcb" href="<?php bloginfo('template_url'); ?>/admin/img/cb_carousel.jpg" title="<?php _e( 'Post carousel', 'tcd-w' ); ?>"><?php _e( 'Post carousel', 'tcd-w' ); ?></a></li>
      <li><a data-rel="lightcase:indexcb" href="<?php bloginfo('template_url'); ?>/admin/img/cb_featured.jpg" title="<?php _e( 'Tab post content', 'tcd-w' ); ?>"><?php _e( 'Tab post content', 'tcd-w' ); ?></a></li>
      <li><a data-rel="lightcase:indexcb" href="<?php bloginfo('template_url'); ?>/admin/img/cb_category.jpg" title="<?php _e( 'Category post', 'tcd-w' ); ?>"><?php _e( 'Category post', 'tcd-w' ); ?></a></li>
      <li><a data-rel="lightcase:indexcb" href="<?php bloginfo('template_url'); ?>/admin/img/cb_trend.jpg" title="<?php _e( 'Three column post content', 'tcd-w' ); ?>"><?php _e( 'Three column post content', 'tcd-w' ); ?></a></li>
      <li><a data-rel="lightcase:indexcb" href="<?php bloginfo('template_url'); ?>/admin/img/cb_author_carousel.jpg" title="<?php _e( 'Author list', 'tcd-w' ); ?>"><?php _e( 'Author list', 'tcd-w' ); ?></a></li>
      <li><a data-rel="lightcase:indexcb" href="<?php bloginfo('template_url'); ?>/admin/img/cb_news.jpg" title="<?php _e( 'News list', 'tcd-w' ); ?>"><?php _e( 'News list', 'tcd-w' ); ?></a></li>
     </ul>
   ...
   <div class="contents_builder_wrap index_content_type1_option" style="<?php if($options['index_content_type'] == 'type1') { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
    ...
    <div class="contents_builder-clone hidden">
     ...
     <?php
          ...
          the_cb_content_setting('cb_cloneindex', 'featured_content');
          the_cb_content_setting('cb_cloneindex', 'category_post');
          the_cb_content_setting('cb_cloneindex', 'trend');
          the_cb_content_setting('cb_cloneindex', 'author_list');
...
function add_front_page_theme_options_validate( $input ) {
  ...
  // 記事スライダー
  $input['index_post_slider_post_type'] = wp_filter_nohtml_kses( $input['index_post_slider_post_type'] );
  $input['index_post_slider_post_order'] = wp_filter_nohtml_kses( $input['index_post_slider_post_order'] );
  $input['index_post_slider_post_num'] = wp_filter_nohtml_kses( $input['index_post_slider_post_num'] );
  $input['index_post_slider_title_font_size'] = wp_filter_nohtml_kses( $input['index_post_slider_title_font_size'] );
  $input['index_post_slider_title_font_size_mobile'] = wp_filter_nohtml_kses( $input['index_post_slider_title_font_size_mobile'] );
  $input['index_post_slider_show_category'] = ! empty( $input['index_post_slider_show_category'] ) ? 1 : 0;
  $input['index_post_slider_show_author'] = ! empty( $input['index_post_slider_show_author'] ) ? 1 : 0;
  $input['index_post_slider_show_date'] = ! empty( $input['index_post_slider_show_date'] ) ? 1 : 0;
  $input['index_post_slider_show_update'] = ! empty( $input['index_post_slider_show_update'] ) ? 1 : 0;

  // ヘッダーコンテンツタイプ3
  $input['index_header_content_type3_post_type'] = wp_filter_nohtml_kses( $input['index_header_content_type3_post_type'] );
  $input['index_header_content_type3_post_order'] = wp_filter_nohtml_kses( $input['index_header_content_type3_post_order'] );
  $input['index_header_content_type3_title_font_size'] = wp_filter_nohtml_kses( $input['index_header_content_type3_title_font_size'] );
  $input['index_header_content_type3_title_font_size_mobile'] = wp_filter_nohtml_kses( $input['index_header_content_type3_title_font_size_mobile'] );
  $input['index_header_content_type3_show_category'] = ! empty( $input['index_header_content_type3_show_category'] ) ? 1 : 0;
  $input['index_header_content_type3_show_author'] = ! empty( $input['index_header_content_type3_show_author'] ) ? 1 : 0;
  $input['index_header_content_type3_show_date'] = ! empty( $input['index_header_content_type3_show_date'] ) ? 1 : 0;
  $input['index_header_content_type3_show_update'] = ! empty( $input['index_header_content_type3_show_update'] ) ? 1 : 0;
  $input['index_header_content_type3_use_overlay'] = ! empty( $input['index_header_content_type3_use_overlay'] ) ? 1 : 0;
  $input['index_header_content_type3_overlay_color'] = wp_filter_nohtml_kses( $input['index_header_content_type3_overlay_color'] );
  $input['index_header_content_type3_overlay_opacity'] = wp_filter_nohtml_kses( $input['index_header_content_type3_overlay_opacity'] );
  ...
  if ( isset( $input['index_slider'] ) && is_array( $input['index_slider'] ) ) {
    foreach ( $input['index_slider'] as $key => $value ) {
      $index_slider[] = array(
        ...
        'post_type' => isset( $input['index_slider'][$key]['post_type'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['post_type'] ) : 'recent_post',
        'post_order' => isset( $input['index_slider'][$key]['post_order'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['post_order'] ) : 'date',
        'post_title_font_size' => isset( $input['index_slider'][$key]['post_title_font_size'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['post_title_font_size'] ) : '32',
        'post_title_font_size_mobile' => isset( $input['index_slider'][$key]['post_title_font_size_mobile'] ) ? wp_filter_nohtml_kses( $input['index_slider'][$key]['post_title_font_size_mobile'] ) : '18',
        'post_show_category' => ! empty( $input['index_slider'][$key]['post_show_category'] ) ? 1 : 0,
        'post_show_author' => ! empty( $input['index_slider'][$key]['post_show_author'] ) ? 1 : 0,
        'post_show_date' => ! empty( $input['index_slider'][$key]['post_show_date'] ) ? 1 : 0,
        'post_show_update' => ! empty( $input['index_slider'][$key]['post_show_update'] ) ? 1 : 0,
      );
    }
  };
    ...
    <h4 class="theme_option_headline2"><?php _e('Header', 'tcd-w');  ?></h4>
     <ul class="option_list">
      <li class="cf">
       ...
       <input type="text" class="full_width cb-repeater-label" name="dp_options[contents_builder][<?php echo $cb_index; ?>][headline]" value="<?php echo esc_html($value['headline']); ?>" />
      ...
      <li class="cf">
       ...
       <textarea class="full_width" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc]"><?php echo esc_textarea(  $value['desc'] ); ?></textarea>
      </li>
     </ul>
    ...
    <h4 class="theme_option_headline2"><?php _e('Carousel', 'tcd-w');  ?></h4>
     <ul class="option_list">
      <li class="cf"><span class="label"><span class="num">3</span><?php _e('Carousel type', 'tcd-w');  ?></span>
       <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][carousel_type]">
      ...
      <li class="cf space"><span class="label"><?php _e('Number of post to display', 'tcd-w');  ?></span>
       <div class="display_post_num_option">
        <label class="number_option">
         <input class="hankaku" type="number" min="-1" name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_num]" value="<?php esc_attr_e( $value['post_num'] ); ?>" />
         <span class="icon icon_pc"></span>
        </label>
        <label class="number_option">
         <input class="hankaku" type="number" min="-1" name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_num_mobile]" value="<?php esc_attr_e( $value['post_num_mobile'] ); ?>" />
      ...
      <li class="cf space"><span class="label"><?php _e('Font size of title', 'tcd-w'); ?></span>
       <div class="font_size_option">
        <label class="font_size_label number_option">
         <input class="font_size hankaku" type="number" name="dp_options[contents_builder][<?php echo $cb_index; ?>][title_font_size]" value="<?php esc_attr_e( $value['title_font_size'] ); ?>" />
         <span class="icon icon_pc"></span>
        </label>
        <label class="font_size_label number_option">
         <input class="font_size hankaku" type="number" name="dp_options[contents_builder][<?php echo $cb_index; ?>][title_font_size_mobile]" value="<?php esc_attr_e( $value['title_font_size_mobile'] ); ?>" />
         <span class="icon icon_sp"></span>
        </label>
       </div>
      </li>
      <li class="cf space"><span class="label"><?php _e('Display category', 'tcd-w'); ?></span><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_category]" type="checkbox" value="1" <?php checked( $value['show_category'], 1 ); ?>></li>
      <li class="cf space"><span class="label"><?php _e('Display author', 'tcd-w'); ?></span><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_author]" type="checkbox" value="1" <?php checked( $value['show_author'], 1 ); ?>></li>
      <li class="cf space"><span class="label"><?php _e('Display date', 'tcd-w'); ?></span><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_date]" type="checkbox" value="1" <?php checked( $value['show_date'], 1 ); ?>></li>
      <li class="cf space">
       <span class="label"><?php _e('Native ads setting', 'tcd-w'); ?></span>
       <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_ads]" type="checkbox" value="1" <?php checked( $value['show_ads'], 1 ); ?>> <?php _e( 'Display native ads', 'tcd-w' ); ?></label></p>
       <div style="<?php if($value['show_ads'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
        ...
        <p><input class="hankaku" style="width:70px;" type="number" max="9999" min="1" step="1" name="dp_options[contents_builder][<?php echo $cb_index; ?>][banner_num]" value="<?php echo esc_attr( $value['banner_num'] ); ?>" /></p>
       </div>
      </li>
     </ul>
...
?>
  ...
  <div class="cb_content tab_parent button_option_parent">
   ...
   <div class="cb_image">
    <img src="<?php bloginfo('template_url'); ?>/admin/img/cb_image_featured.jpg" width="" height="" />
   </div>
   ...
   <div class="sub_box_tab_content<?php if($i == 1){ echo ' active'; }; ?>" data-tab-content="tab<?php echo $i; ?>">
     <ul class="option_list">
      <li class="cf">
       <span class="label"><span class="num">3</span><?php _e('Display this tab', 'tcd-w'); ?></span>
       <label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_post_list<?php echo $i; ?>]" type="checkbox" value="1" <?php checked( $value['show_post_list'.$i], 1 ); ?>></label>
      </li>
      <li class="cf space">
       <span class="label"><?php _e('Headline', 'tcd-w'); ?></span>
       <input type="text" class="tab_label full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_headline<?php echo $i; ?>]" value="<?php echo esc_html(  $value['post_headline'.$i] ); ?>" />
      </li>
      <li class="cf">
       <span class="label"><span class="num">4</span><?php _e('Post type', 'tcd-w');  ?></span>
       <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_type<?php echo $i; ?>]">
      ...
      <li class="cf space">
       ...
       <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_order<?php echo $i; ?>]">
      ...
      <li class="cf space">
       ...
       <p class="displayment_checkbox"><label><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_ads<?php echo $i; ?>]" type="checkbox" value="1" <?php checked( $value['show_ads'.$i], 1 ); ?>></label></p>
       <div style="<?php if($value['show_ads1'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
        <div class="theme_option_message2">
         <p><?php _e('Native ads will be displayed at number of articles set below.<br>For example if you set the number 3, native ads will be displayed between second post and third post.', 'tcd-w'); ?></p>
        </div>
        <p><input class="hankaku" style="width:70px;" type="number" max="9999" min="1" step="1" name="dp_options[contents_builder][<?php echo $cb_index; ?>][banner_num<?php echo $i; ?>]" value="<?php echo esc_attr( $value['banner_num'.$i] ); ?>" /></p>
       </div>
      </li>
     </ul>
   ...
   <div class="sub_box_tab_content" data-tab-content="tab4">
     <ul class="option_list">
      <li class="cf">
       <span class="label"><span class="num">4</span><?php _e('Number of post to display', 'tcd-w');  ?></span>
       <div class="display_post_num_option">
        <label class="number_option">
         <input class="hankaku" type="number" min="-1" name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_num]" value="<?php esc_attr_e( $value['post_num'] ); ?>" />
         <span class="icon icon_pc"></span>
      ...
      <li class="cf space">
       ...
       <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_animation]">
      ...
      <li class="cf space">
       ...
       <input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_category]" type="checkbox" value="1" <?php checked( $value['show_category'], 1 ); ?>>
      </li>
      <li class="cf space">
       <span class="label"><?php _e('Display author', 'tcd-w'); ?></span>
       <input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_author]" type="checkbox" value="1" <?php checked( $value['show_author'], 1 ); ?>>
      </li>
      <li class="cf space">
       <span class="label"><?php _e('Display date', 'tcd-w'); ?></span>
       <input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_date]" type="checkbox" value="1" <?php checked( $value['show_date'], 1 ); ?>>
      </li>
     </ul>
   </div><!-- END .sub_box_tab_content -->
...
?>
  ...
  <div class="cb_content tab_parent button_option_parent">
   ...
   <div class="cb_image">
    <img src="<?php bloginfo('template_url'); ?>/admin/img/cb_image_category.jpg" width="" height="" />
   </div>
   ...
   <div class="sub_box_tab_content active" data-tab-content="tab1">
     <ul class="option_list">
      ...
      <li class="cf">
       <span class="label"><span class="num">2</span><?php _e('Catchphrase', 'tcd-w'); ?></span>
      ...
      <li class="cf">
       <span class="label"><span class="num">3</span><?php _e('Description', 'tcd-w'); ?></span>
       <textarea class="full_width" cols="50" rows="3" name="dp_options[contents_builder][<?php echo $cb_index; ?>][desc]"><?php echo esc_textarea(  $value['desc'] ); ?></textarea>
      </li>
      <li class="cf">
       <span class="label"><span class="num">4</span><?php _e('Archive page link label', 'tcd-w');  ?></span>
       <input type="text" class="full_width" name="dp_options[contents_builder][<?php echo $cb_index; ?>][link_label]" value="<?php echo esc_html($value['link_label']); ?>" />
      </li>
     </ul>
   </div><!-- END .sub_box_tab_content -->
   ...
   <div class="sub_box_tab_content" data-tab-content="tab2">
     <ul class="option_list">
      <li class="cf">
       <span class="label"><span class="num">5</span><?php _e('Category of post', 'tcd-w');  ?></span>
       <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][cat_id]">
   ...
   <div class="sub_box_tab_content" data-tab-content="tab3">
     <ul class="option_list">
      <li class="cf">
       ...
       <div class="theme_option_message2" style="margin-left: 35px;">
      ...
      <li class="cf space">
       ...
       <input class="use_para_checkbox" name="dp_options[contents_builder][<?php echo $cb_index; ?>][use_para]" type="checkbox" value="1" <?php checked( $value['use_para'], 1 ); ?>>
       <div class="theme_option_message2" style="clear:both;">
      ...
      <li class="cf space">
       ...
       <input name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_use_overlay]" type="checkbox" value="1" <?php checked( $value['bg_use_overlay'], 1 ); ?>>
      </li>
      <li class="cf space"><span class="label"><?php _e('Color of overlay', 'tcd-w'); ?></span><input type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_overlay_color]" value="<?php echo esc_attr( $value['bg_overlay_color'] ); ?>" data-default-color="#000000" class="c-color-picker"></li>
      <li class="cf space">
       <span class="label"><?php _e('Transparency of overlay', 'tcd-w'); ?></span>
       <input class="hankaku" style="width:70px;" type="number" max="1" min="0" step="0.1" name="dp_options[contents_builder][<?php echo $cb_index; ?>][bg_overlay_opacity]" value="<?php echo esc_attr( $value['bg_overlay_opacity'] ); ?>" />
...
?>
  ...
  <div class="cb_content tab_parent button_option_parent">
   ...
   <div class="cb_image">
    <img src="<?php bloginfo('template_url'); ?>/admin/img/cb_image_trend.jpg" width="" height="" />
   </div>
   ...
   <div class="sub_box_tab_content active" data-tab-content="tab1">
     <ul class="option_list">
      <li class="cf">
       <span class="label"><span class="num">3</span><?php _e('Post type', 'tcd-w');  ?></span>
        <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_type1]">
      ...
      <li class="cf space">
       <span class="label"><?php _e('Post order', 'tcd-w');  ?></span>
       <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_order1]">
   ...
   <div class="sub_box_tab_content" data-tab-content="tab2">
     <ul class="option_list">
      <li class="cf">
       <span class="label"><span class="num">4</span><?php _e('Post type', 'tcd-w');  ?></span>
        <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_type2]">
      ...
      <li class="cf space">
       <span class="label"><?php _e('Post order', 'tcd-w');  ?></span>
       <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_order2]">
      ...
      <li class="cf"><span class="label"><span class="num">5</span><?php _e('Display author', 'tcd-w'); ?></span><input name="dp_options[contents_builder][<?php echo $cb_index; ?>][show_author]" type="checkbox" value="1" <?php checked( $value['show_author'], 1 ); ?>></li>
     </ul>
   </div><!-- END .sub_box_tab_content -->
   ...
   <div class="sub_box_tab_content" data-tab-content="tab3">
     <ul class="option_list">
      <li class="cf">
       <span class="label"><span class="num">6</span><?php _e('Post type', 'tcd-w');  ?></span>
        <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_type3]">
      ...
      <li class="cf space">
       <span class="label"><?php _e('Post order', 'tcd-w');  ?></span>
       <select name="dp_options[contents_builder][<?php echo $cb_index; ?>][post_order3]">
...
?>
  ...
  <div class="cb_content tab_parent button_option_parent">
   ...
   <div class="cb_image">
    <img src="<?php bloginfo('template_url'); ?>/admin/img/cb_image_author_carousel.jpg" width="" height="" />
   </div>
...
?>
  <?php if($counter>0) { ?>
   ...
   <div class="contributors_list_wrapper">
     <input type="hidden" name="dp_options[contents_builder][<?php echo $cb_index; ?>][author_list_order]" value="">
     <ul class="contributors_list ui-sortable">
      ...
      ?>
       <li class="item">
         <label>
           <input name="dp_options[contents_builder][<?php echo $cb_index; ?>][author_list_order][]" type="checkbox" value="<?php echo $user_id; ?>" <?php checked( in_array( $user_id, $value['author_list_order'] ), true ); ?> />
   ...
   <h4 class="theme_option_headline2"><?php _e('Other setting', 'tcd-w');  ?></h4>
     <ul class="option_list">
      <li class="cf">
        ...
        <div class="font_size_option">
          <label class="font_size_label number_option">
           <input class="font_size hankaku" type="number" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][margin_top]" value="<?php esc_attr_e( $value['margin_top'] ); ?>" />
           <span class="icon icon_pc"></span>
          </label>
          <label class="font_size_label number_option">
           <input class="font_size hankaku" type="number" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][margin_top_mobile]" value="<?php esc_attr_e( $value['margin_top_mobile'] ); ?>" />
           <span class="icon icon_sp"></span>
          </label>
        </div>
      </li>
      <li class="cf">
        ...
        <div class="font_size_option">
          <label class="font_size_label number_option">
           <input class="font_size hankaku" type="number" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][margin_bottom]" value="<?php esc_attr_e( $value['margin_bottom'] ); ?>" />
           <span class="icon icon_pc"></span>
          </label>
          <label class="font_size_label number_option">
           <input class="font_size hankaku" type="number" type="text" name="dp_options[contents_builder][<?php echo $cb_index; ?>][margin_bottom_mobile]" value="<?php esc_attr_e( $value['margin_bottom_mobile'] ); ?>" />
           <span class="icon icon_sp"></span>
          </label>
        </div>
      </li>
