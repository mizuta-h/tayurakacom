...
$load_screen_options = array(
 'type1' => array('value' => 'type1','label' => __( 'Don\'t display load icon', 'tcd-w' )),
...
$load_icon_type = array(
 'type1' => array('value' => 'type1','label' => __( 'Circle icon', 'tcd-w' )),
 'type2' => array('value' => 'type2','label' => __( 'Square icon', 'tcd-w' )),
 'type3' => array('value' => 'type3','label' => __( 'Dot circle icon', 'tcd-w' )),
...
$item_type_options = array(
  ...
  'type4' => array('value' => 'type4','label' => __( 'Blog post', 'tcd-w' ))
);
...
$post_list_animation_type_options = array(
  'type1' => array('value' => 'type1','label' => __( 'Fade in', 'tcd-w' )),
  'type2' => array('value' => 'type2','label' => __( 'Popup', 'tcd-w' )),
  'type3' => array('value' => 'type3','label' => __( 'Slide up', 'tcd-w' ))
);
...
$footer_cta_type_options = array(
	'type1' => array(
		'value' => 'type1',
		'label' => __( 'Type1', 'tcd-w' ),
		'image' => get_template_directory_uri() . '/admin/img/footer_cta_type1.jpg'
	),
	'type2' => array(
		'value' => 'type2',
		'label' => __( 'Type2', 'tcd-w' ),
		'image' => get_template_directory_uri() . '/admin/img/footer_cta_type2.jpg'
	),
	'type3' => array(
		'value' => 'type3',
		'label' => __( 'Type3', 'tcd-w' ),
		'image' => get_template_directory_uri() . '/admin/img/footer_cta_type3.jpg'
	)
);
