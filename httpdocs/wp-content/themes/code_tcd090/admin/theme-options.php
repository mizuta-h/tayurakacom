...
/**
 * tcdcode オプションTools デフォルト画像設定フィルター
 */
function tcdcode_theme_options_tools_get_default_images_settings( $default_images_settings ) {
	// デフォルト画像設定
	return array(
/*
		array(
...
*/
		...
		array(
			'media_filename' => 'image_1450x580.gif',
			'source_filepath' => get_template_directory() . '/admin/img/default/image_1450x580.gif',
			'theme_option_keys' => array("['contents_builder'][1]['bg_image']")
		),
		array(
			'media_filename' => 'image_1450x560.gif',
			'source_filepath' => get_template_directory() . '/admin/img/default/image_1450x560.gif',
			'theme_option_keys' => array("archive_blog_header_bg_image")
		),
		array(
			'media_filename' => 'image_910x360.gif',
			'source_filepath' => get_template_directory() . '/admin/img/default/image_910x360.gif',
...
/**
 * tcdcode オプションTools サンプルカテゴリー
 */
function tcdcode_theme_options_tools_set_sample_categories( $dp_options ) {
...
/**
 * tcdcode オプションTools サンプル記事 ---------------------------------------------------------------------------
 */
function tcdcode_theme_options_tools_set_sample_posts( $dp_options ) {

	// ブログのアイキャッチ画像
	$media_id = (int) theme_options_tools_get_media_id( array(
		'media_filename' => 'image_884x600.gif',
		'source_filepath' => get_template_directory() . '/admin/img/default/image_884x600.gif'
	), true );
...
/**
 * tcdcode オプションTools サンプルメニュー ------------------------------------------------------------------
 */
function tcdcode_theme_options_tools_set_sample_menus( $dp_options ) {
...
/**
 * tcdcode オプションTools サンプルウィジェット -----------------------------------------------------------------
 */
function tcdcode_theme_options_tools_set_sample_widgets( $dp_options ) {
	...
	// ウィジェットエリアの設定
	foreach( array( 'post_single_widget' ) as $sidebar ) {
		// 現ウィジェットを設定を削除
 ...
 * tcdcode テーマ初期化フィルター ----------------------------------------------------------------------------
 */
add_filter( 'tcd_theme_options_tools-get_default_images_settings', 'tcdcode_theme_options_tools_get_default_images_settings', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'tcdcode_theme_options_tools_set_sample_categories', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'tcdcode_theme_options_tools_set_sample_posts', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'tcdcode_theme_options_tools_set_sample_menus', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'tcdcode_theme_options_tools_set_sample_widgets', 10, 1 );
