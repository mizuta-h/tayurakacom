...
.p-footer-cta--<?php echo esc_html($i); ?>.footer_cta_type1 .catch { color:<?php echo esc_html($catch_font_color); ?>; }
.p-footer-cta--<?php echo esc_html($i); ?>.footer_cta_type1 #js-footer-cta__btn { color:<?php echo esc_html($button_font_color); ?>; background:<?php echo esc_html($button_bg_color); ?>; }
...
.p-footer-cta--<?php echo esc_html($i); ?>.footer_cta_type2 .catch { color:<?php echo esc_html($catch_font_color); ?>; }
.p-footer-cta--<?php echo esc_html($i); ?>.footer_cta_type2 #js-footer-cta__btn { color:<?php echo esc_html($button_font_color); ?>; background:<?php echo esc_html($button_bg_color); ?>; }
...
<?php
       elseif ( $options['footer_cta_type' . $i] == 'type3') :
		$footer_cta_image_overlay = $options['footer_cta_type3_overlay_color' . $i];
		$footer_cta_image_opacity = $options['footer_cta_type3_overlay_opacity' . $i];
...
#js-footer-cta.p-footer-cta--<?php echo esc_html($i); ?>.footer_cta_type3 .overlay{ background:<?php echo esc_html($footer_cta_image_overlay); ?>;opacity:<?php echo esc_html($footer_cta_image_opacity); ?>; }
.p-footer-cta--<?php echo esc_html($i); ?>.footer_cta_type3 .catch { color:<?php echo esc_html($catch_font_color); ?>; }
.p-footer-cta--<?php echo esc_html($i); ?>.footer_cta_type3 #js-footer-cta__btn { color:<?php echo esc_html($button_font_color); ?>; background:<?php echo esc_html($button_bg_color); ?>; }
