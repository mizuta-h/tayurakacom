...
?>
<p><?php _e('This option will be used in widget and other content.', 'tcd-w');  ?></p>
<ul>
 ...
 <li><label><input type="checkbox" name="pickup_post" value="on" <?php if( $pickup_post == 'on' ) { ?>checked="checked"<?php } ?> />  <?php _e('Show this post for pickup post', 'tcd-w');  ?></label></li>
</ul>
<?php
}
