...
function seo_meta_box() {
  $post_types = array ( 'post', 'page', 'news', 'showroom');
  add_meta_box(
...
function seo_title( $title, $sep ) {
  ...
  $options = get_design_plus_option();
    ...
    $page_id = get_queried_object_id();
		if(get_post_meta( $page_id, 'tcd-w_meta_title', true )){
			$title = get_post_meta( $page_id, 'tcd-w_meta_title', true );
    } else {
...
function get_seo_description() {
    ...
    $page_id = get_queried_object_id();
		if(get_post_meta( $page_id, 'tcd-w_meta_description', true )){
			$trim_content = get_post_meta( $page_id, 'tcd-w_meta_description', true );
			$trim_content = str_replace( array( "\r\n", "\r", "\n" ), '', $trim_content );
			$trim_content = htmlspecialchars( $trim_content );
			return esc_html( $trim_content );
    } else {
