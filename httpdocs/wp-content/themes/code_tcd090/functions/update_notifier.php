...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_code.xml';
    $db_cache_field = 'code-contempo-notifier-cache';
    $db_cache_field_last_updated = 'code-contempo-notifier-last-updated';
